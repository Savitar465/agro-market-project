...
export default function Navbar({
  ...
  const { isAuthenticated, isAuthLoading, logout, isSeller, isAdmin } =
    useAuth();
              ...
              <div className="ml-auto flex items-center">
                ...
                <form
                  onSubmit={(e) => {
                    ...
                    router.push(`/store?q=${encodeURIComponent(input.value)}`);
                  }}
                  className="hidden lg:flex lg:ml-6 items-center gap-2"
                >
